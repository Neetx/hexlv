...
build/test_library.o: src/lib/test_library.c
	gcc -c src/lib/test_library.c -o build/test_library.o -std=gnu99 -O2 -nostdlib -ffreestanding -Wall -m64 -Wextra -Iinclude/lib/

build/kernel.o: src/kernel/kernel.c
	gcc -c src/kernel/kernel.c -o build/kernel.o -std=gnu99 -ffreestanding -O2 -nostdlib -Wall -m64 -Wextra -Iinclude/lib/
